...
public class CaskanjeActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caskanje);

        lvDiscussionTopics=(ListView)findViewById(R.id.lvDiscussionTopics);
        arrayAdpt=new ArrayAdapter(this, R.layout.boja,listOfDiscussion);
