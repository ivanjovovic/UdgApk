...
public class KvizActivity extends Activity {
    ...
    private Pitanja mQuestions=new Pitanja();
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(KvizActivity.this);
        alertDialogBuilder
                .setMessage("Kraj igre! Sakupio si"+ mScore + " poena.")
                .setCancelable(false)
                .setPositiveButton("Probaj opet", new DialogInterface.OnClickListener() {
                    @Override
